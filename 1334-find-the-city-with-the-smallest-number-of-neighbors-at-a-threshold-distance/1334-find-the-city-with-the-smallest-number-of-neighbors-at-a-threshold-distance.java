class Solution {
    public int findTheCity(int n, int[][] edges, int distanceThreshold) {
        ...
        for(int i = 0; i < n; i++){
            ...
            //some logic
            //get neighbors
            // iterate all neighbors with distance < threshold
            // add neighbors of nodes with distance < threshold and update threshold
            // keep track of total neighbors at distance threshold
            ...
            //System.out.println("Index: "+ i+" Cities Visited: "+ citiesVisited);
