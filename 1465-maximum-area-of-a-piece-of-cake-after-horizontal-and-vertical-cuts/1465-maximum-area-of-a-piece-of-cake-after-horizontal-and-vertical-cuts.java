class Solution {
   public int maxArea(int h, int w, int[] horizontalCuts, int[] verticalCuts) {
        ...
        int maxHorizontal = Math.max(horizontalCuts[0], h - horizontalCuts[horizontalCuts.length - 1]), maxVertical = Math.max(verticalCuts[0], w - verticalCuts[verticalCuts.length - 1]);
